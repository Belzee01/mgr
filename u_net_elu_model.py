...
def create(n_classes=1, base=2, pretrained=False, pretrained_model_path='', learning_rate=1e-6):
    if n_classes == 1:
    ...
    c_1 = tf.keras.layers.Conv2D(2 ** b, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same')(
        converted_inputs)
    ...
    c_2 = tf.keras.layers.Conv2D(2 ** (b + 1), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(p_1)
    ...
    c_3 = tf.keras.layers.Conv2D(2 ** (b + 2), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(p_2)
    ...
    c_4 = tf.keras.layers.Conv2D(2 ** (b + 3), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(p_3)
    ...
    c_5 = tf.keras.layers.Conv2D(2 ** (b + 4), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(p_4)
    ...
    c_6 = tf.keras.layers.Conv2D(2 ** (b + 5), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(p_5)
    ...
    c_7 = tf.keras.layers.Conv2D(2 ** (b + 6), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(p_6)
    ...
    c_8 = tf.keras.layers.Conv2D(2 ** (b + 5), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(u_6)
    ...
    c_9 = tf.keras.layers.Conv2D(2 ** (b + 4), (3, 3), activation='elu', kernel_initializer='he_normal',
                                 padding='same')(u_7)
    ...
    c_10 = tf.keras.layers.Conv2D(2 ** (b + 3), (3, 3), activation='elu', kernel_initializer='he_normal',
                                  padding='same')(u_8)
    ...
    c_11 = tf.keras.layers.Conv2D(2 ** (b + 2), (3, 3), activation='elu', kernel_initializer='he_normal',
                                  padding='same')(u_9)
    ...
    c_12 = tf.keras.layers.Conv2D(2 ** (b + 1), (3, 3), activation='elu', kernel_initializer='he_normal',
                                  padding='same')(u_10)
    ...
    c_13 = tf.keras.layers.Conv2D(2 ** b, (3, 3), activation='elu', kernel_initializer='he_normal',
                                  padding='same')(u_11)
...
model = create(base=2, n_classes=len(color_labels), pretrained=True,
               pretrained_model_path='models/unet_elu_20210511-180856.model',
               learning_rate=1e-6)

# Model checkpoints
model_name = 'unet_elu_' + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
